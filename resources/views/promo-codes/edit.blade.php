...
<div class="mb-8">
    <div class="mb-6">
        <h1 class="text-3xl font-bold">Edit Promo Code</h1>
        <p class="text-base-content/70 mt-2">Update discount code details</p>
    </div>
            ...
            <form action="{{ route('promo-codes.update', $promoCode) }}" method="POST">
                ...
                <div class="form-control w-full mb-4">
                    ...
                    <input
                        ...
                        value="{{ old('percent_off', $promoCode->percent_off) }}"
                        min="1"
                        max="100"
                        required
                    >
    ...
    <div class="alert alert-info mt-6 max-w-2xl">
        ...
        <div>
            <h3 class="font-bold">Editing Promo Codes</h3>
            <ul class="list-disc list-inside text-sm mt-2 space-y-1">
                <li>You can safely change the discount percentage</li>
                <li>Toggle active/inactive to enable or disable the code</li>
                <li>Changing the code will not affect past uses</li>
                <li>Inactive codes cannot be used by customers</li>
            </ul>
        </div>
    </div>
</div>
