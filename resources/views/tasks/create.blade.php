    ...
    <div class="card bg-base-100 shadow-xl">
        <div class="bg-gradient-to-r from-indigo-500 to-indigo-600 text-white">
            <div class="card-body">
                ...
                <p class="text-indigo-100">Add a new truth, dare, or group task to the collection</p>
            </div>
        </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                                    <label class="cursor-pointer">
                                        <input
                                            ...
                                            value="any"
                                            class="hidden peer"
                                            {{ old('someone_gender', 'any') === 'any' ? 'checked' : '' }}
                                        >
                                        <div class="card border-2 border-base-300 peer-checked:border-primary peer-checked:bg-primary/10 hover:border-primary/50 transition-all">
                                            <div class="card-body p-3 flex-row items-center gap-3">
                                                <span class="text-2xl">🌐</span>
                                    ...
                                    <label class="cursor-pointer">
                                        <input
                                            ...
                                            value="same"
                                            class="hidden peer"
                                            {{ old('someone_gender') === 'same' ? 'checked' : '' }}
                                        >
                                    ...
                                    <label class="cursor-pointer">
                                        <input
                                            ...
                                            value="other"
                                            class="hidden peer"
                                            {{ old('someone_gender') === 'other' ? 'checked' : '' }}
                                        >
                                        ...
                                        @foreach($tags as $tag)
                                            <label class="cursor-pointer">
                                                <input
                                                    ...
                                                    value="{{ $tag->id }}"
                                                    class="hidden peer"
                                                    {{ (is_array(old('someone_tags')) && in_array($tag->id, old('someone_tags'))) ? 'checked' : '' }}
                                                >
                                                <div class="card border-2 border-base-300 peer-checked:border-info peer-checked:bg-info/10 hover:border-info/50 transition-all">
                                                    <div class="card-body p-3 flex-row items-center gap-3">
                                                        <span class="text-2xl">👤</span>
                                        ...
                                        @foreach($tags as $tag)
                                            <label class="cursor-pointer">
                                                <input
                                                    ...
                                                    value="{{ $tag->id }}"
                                                    class="hidden peer"
                                                    {{ (is_array(old('someone_cant_have_tags')) && in_array($tag->id, old('someone_cant_have_tags'))) ? 'checked' : '' }}
                                                >
                                                <div class="card border-2 border-base-300 peer-checked:border-warning peer-checked:bg-warning/10 hover:border-warning/50 transition-all">
                                                    <div class="card-body p-3 flex-row items-center gap-3">
                                                        <span class="text-2xl">🚷</span>
