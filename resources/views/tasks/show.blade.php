    ...
    <div class="card bg-base-100 shadow-xl">
        ...
        <div class="card-body">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <a href="{{ route('tasks.random') }}" class="btn btn-success btn-lg {{ auth()->guest() || !Auth::user()->isAdmin() ? 'md:col-span-2' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <a href="{{ route('tasks.index') }}" class="btn btn-ghost btn-lg {{ auth()->guest() || !Auth::user()->isAdmin() ? 'md:col-span-2' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
